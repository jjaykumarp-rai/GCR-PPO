...
class ThrowingGeneralEnvCfg(DirectRLEnvCfg):
    ...
    # optional reward toggles used by ThrowingEnv
    ...
    #     prim_path="/World/envs/env_.*/target",
    #     spawn=sim_utils.CylinderCfg(
    #         radius=0.15,          # disk radius (meters)
    #         height=0.01,          # very thin -> disk-like
    #         axis="X",             # so it’s flat in the YZ plane
    #         rigid_props=sim_utils.RigidBodyPropertiesCfg(
    #             kinematic_enabled=True,
    #             rigid_body_enabled=True,
    #         ),
    #         collision_props=sim_utils.CollisionPropertiesCfg(),  # default is fine
    #         visual_material=sim_utils.PreviewSurfaceCfg(
    #             diffuse_color=(1.0, 0.0, 0.0)   # bright red target
    #         ),
    #     ),
    #     init_state=RigidObjectCfg.InitialStateCfg(
    #         # you can set a default position if you want:
    #         # pos=(0.0, 0.0, 1.0)
    #     ),
    # )
