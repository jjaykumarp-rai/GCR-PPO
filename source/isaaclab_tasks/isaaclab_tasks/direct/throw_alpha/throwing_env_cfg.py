...
# 🔴 IMPORTANT:
# Make sure ALPHA_CFG is defined in this file above, or imported from your alpha robot cfg.
# from .alpha_robot_cfg import ALPHA_CFG

# --------------------------------------------------------------------------
# Optional cobblestone terrain (unchanged)
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# Events – adapted for Alpha (no imu_link, use PLINTH as base)
# --------------------------------------------------------------------------
@configclass
class EventCfg:
    ...
    # For Alpha, there is no 'imu_link'; use 'PLINTH' as the base body.
    ...
    # push_robot event left commented as in your original
...
# --------------------------------------------------------------------------
# Alpha throwing env cfg (was ThrowingGeneralEnvCfg for G1)
# --------------------------------------------------------------------------
@configclass
class ThrowingAlphaGeneralEnvCfg(DirectRLEnvCfg):
    ...
    # --- Terrain (same as your plane version) ---
    ...
    # Optionally: reward-term flags used in your env logic
