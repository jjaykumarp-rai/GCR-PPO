...
gym.register(
    id="Isaac-Velocity-Flat-H1-Direct-v0",
    entry_point=f"{__name__}.h1_env:H1Env",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.h1_env_cfg:H1FlatEnvCfg",
...
gym.register(
    id="Isaac-Velocity-Rough-H1-Direct-v0",
    entry_point=f"{__name__}.h1_env:H1Env",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.h1_env_cfg:H1RoughEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_flat_ppo_cfg.yaml",
