...
class G1LocoManipRewards(G1Rewards):
    ...
    left_ee_pos_tracking = RewTerm(
        ...
        weight=-2.0,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="left_shoulder_yaw_link"),
    ...
    right_ee_pos_tracking = RewTerm(
        ...
        weight=-2.0,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="right_shoulder_yaw_link"),
...
class G1LocoManipCommands:
    ...
    left_ee_pose = mdp.UniformPoseCommandCfg(
        asset_name="robot",
        body_name="left_shoulder_yaw_link",
    ...
    right_ee_pose = mdp.UniformPoseCommandCfg(
        asset_name="robot",
        body_name="right_shoulder_yaw_link",
        resampling_time_range=(1.0, 3.0),
        debug_vis=True,
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            pos_x=(0.10, 0.50),
...
@configclass
class G1LocoManipRoughEnvCfg(G1RoughEnvCfg):
...
class G1LocoManipEnvCfg_PLAY(G1LocoManipRoughEnvCfg):
